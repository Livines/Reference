...
public class StatusChecker {
    ...
    private StatusChecker(Context mContext) {
        this.mContext=mContext;
    }

    public static synchronized StatusChecker getInstance(Context mContext){
        if(instance==null){
            instance = new StatusChecker(mContext.getApplicationContext());
        }
        return instance;
    }
